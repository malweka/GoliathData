    ...
    class CodeGenerator : IGenerator
    {
        ...
        public void GenerateMapping(string workingFolder, ProjectSettings settings, ComplexType baseModel, SupportedRdbms rdbms)
        {
            if ((rdbms == SupportedRdbms.SqlServer2005) || (rdbms == SupportedRdbms.SqlServer2008))
            {
                ...
                {
                    Build(workingFolder, settings, baseModel, schemaDescriptor);
                }
            ...
            else if (rdbms == SupportedRdbms.Sqlite3)
            {
                ...
                {
                    Build(workingFolder, settings, baseModel, schema);
                }
            }
        }
        ...
        void Build(string workingFolder, ProjectSettings settings, ComplexType baseModel, ISchemaDescriptor schema)
        {
